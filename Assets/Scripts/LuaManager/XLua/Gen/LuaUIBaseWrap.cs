...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaUIBaseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(LuaUIBase);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaUIBase __cl_gen_ret = new LuaUIBase();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaUIBase constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                LuaUIBase __cl_gen_to_be_invoked = (LuaUIBase)translator.FastGetCSObj(L, 1);
